    ...
    export default {
        ...
        data() {
            return {
                ...
                smallTitle: '',
                app: 21,
                beCareful: ['1、客户的银行卡及预留手机号、身份证、注册手机号需一致且为同一人，否则会造成无效客户！;','2、需要绑定62开头的银行卡或者信用卡、绑定其他开头的卡片有概率造成绑定不上或者支付不了的情况。','3、所有扫描推广码完成流程的新用户必须使用云闪付扫描付款码交易一笔。', '4、无商家付款码的可以使用下面的付款码进行支付交易1分钱。']
            }
        },
        created() {
            GetYunCode({
