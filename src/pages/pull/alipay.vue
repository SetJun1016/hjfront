    ...
    export default {
        ...
        data() {
            return {
                ...
                app: 22,
                smallTitle: '',
                beCareful: ["1、首次领取福利码的用户需要用支付宝进行扫码完成激活操作。","2、需要打开位置权限，将位置权限选为始终允许。",'3、确保客户手机上下载的支付宝为最新版本。','4、在操作过程中，一定要在4G网络下操作，同一个IP地址下注册多个账号，支付宝系统会判断为刷单、风控数据。', '5、登录支付宝后，请勿领取支付宝首页的话费红包，必须扫福利码拉新时，无法捕捉到数据。', '6、注意提醒客户次日至第七天内再登录一次支付宝APP。']
            }
        },
        created() {
            GetAlipayCode({
